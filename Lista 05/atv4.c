...
switch(mes){ 
    ...
    case 2:
        ...
        if(bissexto == 's'|| bissexto == 'S'){
            printf("Fevereiro, o segundo mês do ano, possui 29 dias em anos bissextos");}     
        
        else if (bissexto == 'n'|| bissexto == 'N'){
            printf("Fevereiro, o segundo mês do ano, possui 28 dias em anos normais");}
        else{ 
